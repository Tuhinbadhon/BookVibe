...
const BookDetails = ({ onAddToReadList }) => {
  const handleReadlist = (book) => {
    saveBook(book);
    onAddToReadList(book); // Call the function to update the readBooks list
  };
  ...
  const handleWishList = (book) => {
    ...
    if (isRead) {
      toast.error("Cannot add to wishlist. Book already exists in read list.");
      return;
    }
    saveWishBook(book);
  };
    ...
    <div className="lg:mx-28 lg:mt-12 mx-4 mb-3 lg:mb-24 mt-3">
      ...
      <div className="lg:flex gap-3 lg:gap-12">
        ...
        <div className="max-[450px]:mt-4 max-[450px]:mb-5">
          <h2 className="card-title font-bold lg:text-4xl">{book.bookName}</h2>
